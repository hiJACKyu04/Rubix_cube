...
│                                                                             │
│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐            │
│  │   LBL Solver    │  │  Two-Phase      │  │  CFOP Solver    │            │
│  │   (lbl.js)      │  │  (two-phase.js) │  │  (cfop.js)      │            │
│  │                 │  │                 │  │                 │            │
│  │ • Step 1: Cross│  │ • Phase 1:      │  │ • Cross (C)     │            │
│  │ • Step 2: F2L   │  │   Subgroup G1   │  │ • F2L (F)      │            │
│  │ • Step 3: OLL   │  │ • Phase 2:      │  │ • OLL (O)      │            │
│  │ • Step 4: PLL   │  │   Subgroup G0   │  │ • PLL (P)      │            │
│  └─────────────────┘  └─────────────────┘  └─────────────────┘            │
│           │                      │                      │                  │
│           └──────────────────────┼──────────────────────┘                  │
│                                  │                                        │
